...
该镜像的 github 地址 ( dockerfile 及构建脚本 ): https://github.com/fufeng24678/dockerfile/tree/main/redis-exporter
...
docker run -d \
  ...
  fufeng24678/redis-exporter:1.53.0
```

## docker-compose 启动

清单地址: https://github.com/fufeng24678/docker-compose/tree/main/redis-exporter 

```yaml
version: '3.8'
services:
  redis-exporter:
    image: fufeng24678/redis-exporter:1.53.0
    restart: always
    environment:
